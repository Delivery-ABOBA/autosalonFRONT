...
function TO(){
  ...
  parent.innerHTML='
	     				<div class="d-flex align-items-center">
                                        	<h2 class="me-auto mb-0">Запись на ТО</h2>
    					
                                    	</div>
                                     <div class="tab-content" role="tablist">
                                        <div class="tab-pane fade active show" id="create-chat-info" role="tabpanel">
                                                        ...
                                                        <div class="row gy-6">
                                                            <div class="col-12">
                                                                <div class="form-floating">
                                                                    ...
                                                                    <label for="floatingInput">Введите марку</label>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="card-body">
                                                    <form autocomplete="off">
                                                        ...
                                                        <div class="col-12">
                                                                ...
                                                                <div class="form-floating">
                                                                    <input type="text" class="form-control" id="floatingInput" placeholder="Enter a chat name">
                                                                    <label for="floatingInput">Введите год выпуска</label>
                                                                </div>
                                                            </div><div class="col-12">
                                                                <div class="form-floating">
                                                                    <input type="text" class="form-control" id="floatingInput" placeholder="Enter a chat name">
                                                                ...
                                                                <div class="form-floating">
                                                                    ...
                                                                    <textarea class="form-control" placeholder="Description" id="floatingTextarea" rows="8" data-autosize="true" style="min-height: 100px; overflow: hidden; overflow-wrap: break-word; resize: none; height: 100px;"></textarea>
                                                                    <label for="floatingTextarea">Опишите проблему</label>
                                                                </div>
                                                            <button class="btn btn-lg btn-primary w-100 d-flex align-items-center" type="button">Записаться
...
function Insurance(){
  var parent=document.getElementById("container");
  parent.innerHTML='<div class="d-flex align-items-center">
                                        	<h2 class="me-auto mb-0">Страховка</h2>
                                                ...
                                                <div class="card-body">
                                                    <form autocomplete="off">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            </div><button class="btn btn-lg btn-primary w-100 d-flex align-items-center" type="button">Оформить
<span class="icon ms-auto">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>
                                    </span>
                                </button></div>
...
function TestDrive(){
  var parent=document.getElementById("container");
  parent.innerHTML='<div class="d-flex align-items-center">
                                        	<h2 class="me-auto mb-0">Тест-Драйв</h2>
